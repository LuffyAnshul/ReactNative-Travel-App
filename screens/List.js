            ...
            <View style={[ styles.flex, styles.row, { justifyContent: 'center', alignItems: 'center' } ]}>
                { destinations.map((item, index) => {
                    ...
                    return (
                        <Animated.View 
                            key={`step-${item.id}`} 
                            style={[ styles.dots, styles.activeDot, { borderWidth: borderWidth, width: dotWidth } ]} 
                        />
                    );
                })}
  ...
  render() {
    return (
      <ScrollView
        ...
        contentContainerStyle={{ paddingBottom: theme.sizes.padding, backgroundColor: theme.colors.white }}
      >
